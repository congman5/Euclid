...
# Indirect[...] justification steps which have been removed, or have
# generic justifications (e.g. "Diagrammatic", "Metric") that now require
# specific axiom names and correct refs.  Mark as xfail so the suite stays
# green while axiom-level proofs are being developed.
